...
class AudioEnc(nn.Module):
    ...
    def __init__(self, config):
        ...
        if config.cnn_encoder.type == 'transformer':
...
class AudioFeature(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.mel_trans = Spectrogram(n_fft=1024,
                                     hop_length=320,
                                     win_length=1024,
                                     window='hann',
                                     center=True,
        ...
        self.log_trans = LogmelFilterBank(sr=32000, 
                                          n_fft=1024,
                                         n_mels=64,
                                         fmin=50,
                                         fmax=14000,
...
class HTSAT_Swin_Transformer(nn.Module):
    ...
    def __init__(self, spec_size=256, patch_size=4, patch_stride=(4, 4),
        ...
        self.freq_ratio = self.spec_size // 64 #self.config["audio_args"]["n_mels"]
...
#     with open("/home/user/audio-text_retrieval/settings/settings.yaml", "r") as f:
